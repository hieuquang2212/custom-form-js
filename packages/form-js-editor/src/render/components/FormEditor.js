...
import {
  ...
  getPaletteIcon,
} from "../../features/palette/components/Palette";
...
function Element(props) {
  ...
  useEffect(() => {
    function scrollIntoView({ selection }) {
      ...
      const isElementLarger =
        elementBounds.height > scrollContainerBounds.height;
      const isNotFullyVisible =
        elementBounds.bottom > scrollContainerBounds.bottom ||
        elementBounds.top < scrollContainerBounds.top;
  ...
  useEffect(() => {
    ...
    function handleCloned(clone, original, type) {
      ...
      if (fieldType) {
        ...
        ["fjs-context-pad", "fjs-row-dragger", "fjs-debug-columns"].forEach(
          (cls) => {
